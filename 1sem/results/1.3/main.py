...
working_dir = os.path.join(os.getcwd(), '1sem/results/1.3')
...
def handle_img(img_name):
    ...
    interpolated_image = bilinear_interpolation(source_image, scale_factor=3)
    result_image = decimation(interpolated_image, 2)

    result_image_path = working_dir + "/output/" + img_name
